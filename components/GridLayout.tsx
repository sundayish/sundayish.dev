...
export default function GridLayout(){
    ...
    return(
        ...
        <div className="grid place-items-center min-h-screen">
            <div className="p-4 max-w-5xl grid gap-4 lg:gap-2.5 grid-cols-2 lg:grid-cols-4 text-white">
                ...
                <div className="h-40 sm:h-auto sm:square">
                    <Linkcard text={"This shall become the link to my blogs section."} link={"/blogs"} />
                </div>
                <div className="h-40 sm:h-auto sm:square">
                ...
                <div className="h-40 bg-blue-500 sm:h-auto sm:square sm:rounded-md">
                    Placeholder
                </div>
